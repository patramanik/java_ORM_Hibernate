            ...
            <div class="card-body p-3">
                <form action="EditStudentServlet" method="post">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-sm" name="name" value="<%=name%>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" name="course" value="<%=course%>" required>
                    </div>
